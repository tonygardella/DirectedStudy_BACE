...
dat.11.fall.m=as.numeric(dat.11$tot.mass)
#Means,95% intervals, standarad deviation, 
dat.11.fall.95=quantile(dat.11.fall.m,c(.05,.95),na.rm=TRUE)
dat.11.fall.mean=mean(dat.11.fall.m,na.rm=TRUE)
dat.11.fall.sd=sd(dat.11.fall.m,na.rm=TRUE)
```
...
##Summary Stats
w.11.fall.95=quantile(w.11.tm,c(.05,.95),na.rm=TRUE)
w.11.fall.mean=mean(w.11.tm,na.rm=TRUE)
w.11.fall.sd=sd(w.11.tm,na.rm=TRUE)

a.11.fall.95=quantile(a.11.tm,c(.05,.95),na.rm=TRUE)
a.11.fall.mean=mean(a.11.tm,na.rm=TRUE)
a.11.fall.sd=sd(a.11.tm,na.rm=TRUE)

d.11.fall.95=quantile(d.11.tm,c(.05,.95),na.rm=TRUE)
d.11.fall.mean=mean(d.11.tm,na.rm=TRUE)
d.11.fall.sd=sd(d.11.tm,na.rm=TRUE)
```
...
##AGGREGATE PLOTS and TABLE
```{r}
hist(dat.08.fall.m,probability=TRUE)
f.08.dist=dnorm(1:78,dat.08.fall.mean,dat.08.fall.sd)
...
lines(1:750,dnorm(1:750,dat.11.fall.mean,dat.11.fall.sd),col=2,type='s')
...
lines(1:730,dnorm(1:730,dat.13.fall.mean,dat.13.fall.sd),col=2,type='s')
hist(dat.14.fall.m,probability=TRUE)
lines(1:370,dnorm(1:370,dat.14.fall.mean,dat.14.fall.sd),col=2,type='s')

#check lognormal, gamma, weibull and create glms
#response to interannual variability systematic, plot effect
#treatment fixed,random plot,fixed year efect

years=c(1:14)
m.bm=c(dat.08.summ.mean,dat.08.fall.mean,dat.09.summ.mean, dat.09.fall.mean,NA,NA,NA,dat.11.fall.mean,NA,dat.12.fall.mean,NA,dat.13.fall.mean,NA,dat.14.fall.mean)

## Mean Biomass Time Series
plot(years,m.bm)

## Treatments Mean Biomass  Time Series
wet.m.bm=c(w.08.fall.mean,w.08.summ.mean,w.09.fall.mean,w.09.summ.mean,NA,NA,NA,w.11.fall.mean,NA,w.12.fall.mean,NA,w.13.fall.mean,NA,w.14.fall.mean)

amb.m.bm=c(a.08.fall.mean,a.08.summ.mean,a.09.fall.mean,a.09.summ.mean,NA,NA,NA,a.11.fall.mean,NA,a.12.fall.mean,NA,a.13.fall.mean,NA,a.14.fall.mean)

dry.m.bm=c(d.08.fall.mean,d.08.summ.mean,d.09.fall.mean,d.09.summ.mean,NA,NA,NA,d.11.fall.mean,NA,d.12.fall.mean,NA,d.13.fall.mean,NA,d.14.fall.mean)
