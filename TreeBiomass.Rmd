...
#combine masses for year and plot mean/range of biomass over time as total and per treatment
#plot over time
#treatment over time
#neighborhood effects
#random block effects, consistently better or worse. spacial effects not explained by covariate
#
